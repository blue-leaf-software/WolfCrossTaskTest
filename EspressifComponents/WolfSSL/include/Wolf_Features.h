...
// Currently not used on embedded device. Available on windows so Discovery Wolf
// can load server certificates with encrypted keys. 
...
// Enable support for alt names in CSR.
// undocumented. 
...
// Currently breaks build for windows. 
#if !defined(_WIN32)
